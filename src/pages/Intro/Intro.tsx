        ...
        <div className={styles.video_wrap}>
          ...
          <div className={styles.container_video}>
            ...
            <div className={styles.strip}>
              {state.page === 1 && (
                <>
                  <div className={styles.strip_rectangle1}></div>
                  <div className={styles.strip_rectangle}></div>
                  <div className={styles.strip_rectangle}></div>
                </>
              )}
              {state.page === 2 && (
            ...
            <Button view="action" size="large" className={styles.button_for_video} onClick={clickButton}>
              {state.button}
            </Button>
            <Link to={'/'}>
